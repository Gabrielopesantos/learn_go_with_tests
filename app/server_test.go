...
func TestStoreWins(t *testing.T) {
	...
	t.Run("in records on POST", func(t *testing.T) {
		player := "Pepper"
...
func TestLeague(t *testing.T) {
	...
	t.Run("it returns 200 on /league", func(t *testing.T) {
		...
		if err != nil {
			t.Fatalf("Unable to parse response from server %q into slice of Player %q", response.Body, got)
		}
...
func getLeagueFromResponse(t testing.TB, body io.Reader) (league []Player) {
	...
	if err != nil {
		t.Fatalf("Unable to parse response from server %q into slice of Player %q", body, league)
	}
	return
}
